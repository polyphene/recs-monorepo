...
// Thanks to @ @ChrisLahaye and other contributors on the dedicated issue of ethers-js: https://github.com/ethers-io/ethers.js/issues/1053
// for this proposed implementation of safer websocket connections.
